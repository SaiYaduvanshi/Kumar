<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Ucntrl_Grup.ascx.cs" Inherits="EgmYKS.Ucntrl.Ucntrl_Grup" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
          <h3>
                                <i class="gi gi-parents"></i>Grup İşlemi
                            </h3>
        ...
        <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="0" EnableTheming="True" Theme="MetropolisBlue" Width="100%">
            <TabPages>
                    ...
                    <ContentCollection>
                        <dx:ContentControl runat="server">
                            <dx:ASPxGridView ID="ASPxGridView2" runat="server" AutoGenerateColumns="False" EnableTheming="True" Theme="Moderno" Width="100%">
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="Grup Adı" FieldName="GRP_ADI" ShowInCustomizationForm="True" VisibleIndex="3" Width="60%">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Seç" ShowInCustomizationForm="True" VisibleIndex="4" Width="5%">
                                        <DataItemTemplate>
                                            <asp:ImageButton ID="ImageButton1" runat="server" CommandArgument='<%# Eval("GRP_ID")+"-"+Eval("GRP_KODU")+"-"+Eval("GRP_ADI")+"-"+Eval("GRP_USRKODU")%>' ImageUrl="~/images/Forward_16x16.png" onclick="ImageButton1_Click1" ToolTip="Seç" />
                                        </DataItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Sil" ShowInCustomizationForm="True" VisibleIndex="5" Width="5%">
                                        <DataItemTemplate>
                                            <asp:ImageButton ID="ImageButton2" runat="server" CommandArgument='<%# Eval("GRP_ID")%>' ImageUrl="~/images/DeleteList2_16x16.png" onclick="ImageButton2_Click" OnClientClick="return confirm('Silmek istiyor musunuz?');" ToolTip="Sil" />
                                        </DataItemTemplate>
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Grup Kodu" FieldName="GRP_KODU" ShowInCustomizationForm="True" VisibleIndex="1" Width="30%">
                                    </dx:GridViewDataTextColumn>
                                </Columns>
                ...
                <dx:TabPage Text="Grup Detay">
                    <ContentCollection>
                        <dx:ContentControl runat="server">
                            <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" EnableTheming="True" KeyFieldName="USR_SICILNO" Theme="Moderno" Width="100%">
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="Kullanıcı Adı" FieldName="USERAD" ShowInCustomizationForm="True" VisibleIndex="5" Width="65%">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Kullanıcı Kodu" ShowInCustomizationForm="True" VisibleIndex="4" Width="30%" FieldName="USR_SICILNO">
                                    </dx:GridViewDataTextColumn>
